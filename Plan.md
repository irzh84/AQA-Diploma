...
2) Валидная дата для поля «Месяц» и «Год» считается 12.23.
...
- заполнение полей невалидными данными и отправка формы. Покупка есть в БД. 
...
ОР - отображается сообщение «Операция одобрена Банком.». Покупка есть в БД. 
